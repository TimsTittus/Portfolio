...
export const volunteeringExperience: Experience[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Collaborated with peers to plan and execute college-wide tech activities including FOSSDAY, Debian installation parties, Season of Commits and Internship',
  ...
  },
  {
    ...
    description: 'Help plan and run IEEE SIGHT community outreach projects.',
    responsibilities: [
