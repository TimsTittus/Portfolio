...
```mermaid
flowchart LR
    A["RECON<br/>map targets in parallel"] --> B["VULN DISCOVERY<br/>surface weak points"]
    B --> C["EXPLOIT DEV<br/>generate + adapt code"]
    C --> D["LATERAL MOVEMENT<br/>harvest creds, pivot"]
    D --> E["EXFILTRATION<br/>collect + stage data"]
    H["HUMAN OPERATOR<br/>4-6 decision points"] -. supervises .-> A
    H -. supervises .-> C
    H -. supervises .-> E
    style H fill:#F5E2D6,stroke:#E65C33,stroke-width:2px
```
...
<FaqItem q="What is an AI-enhanced cyberattack?">
...
<FaqItem q="Has an AI actually run a real cyberattack?">
...
<FaqItem q="Is AI-generated malware real or hype?">
...
<FaqItem q="Does AI phishing really work better than human phishing?">
...
<FaqItem q="What's the single most effective defense against AI-enhanced attacks?">
...
<FaqItem q="How do you detect malware that calls an LLM at runtime?">
